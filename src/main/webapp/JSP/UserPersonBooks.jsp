...
<body>
<div class="button_for_adding_new_book">
  <button style="width: 170pt; height: 30pt; background-color: whitesmoke; font-size: 15px; border-color: lightgrey;" onclick="window.location.href='/YourBook? userID=${userID}'">Добавить свою книгу</button>
...
<div class="books-container">
  ...
  <c:forEach var="book" items="${books}">
    <a>
      ...
      <button style="width: 170pt; height: 30pt; background-color: whitesmoke; font-size: 15px; border-color: lightgrey;" onclick="window.location.href='/YourBook?userID=${userID}&bookText=${book.textOfBook}&bookID=${book.literatureID}'">Редактировать</button>
